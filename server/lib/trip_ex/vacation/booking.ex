defmodule TripEx.Vacation.Booking do
  use Ecto.Schema
  ...
  defp dates_available?(start_date, end_date, place_id) do
    query =
      from booking in TripEx.Vacation.Booking,
        where:
  ...
  defp calculate_total_price(changeset) do
    case changeset.valid? do
      true ->
        ...
        place = TripEx.Repo.get!(TripEx.Vacation.Place, place_id)
