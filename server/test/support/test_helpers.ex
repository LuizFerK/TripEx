defmodule TripEx.TestHelpers do
  alias TripEx.Repo

  alias TripEx.Vacation.{Place, Booking, Review}
  alias TripEx.Accounts.User

  def user(username) do
    TripEx.Repo.get_by!(User, username: username)
  end

  def place(name) do
    TripEx.Repo.get_by!(Place, name: name)
  end
